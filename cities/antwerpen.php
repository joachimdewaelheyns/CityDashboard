...
<html lang="en">
    ...
    <body>
		...
		<div class="packery">
			...
			<div class="item half" id="bikes"  title="Bike sharing info">
				<div class="title">
					<div class="title-text">Bike sharing</div>
					<div class="maki-bicycle"></div>
				</div>
				<div class="content">
					<img src="../img/loader.gif" class="loader"></img>
				</div>
				<div class="footer">
					<span id="bikeCountdown" class="timer"></span>
				</div>
			</div>
			...
			<div class="item half" id="cars"  title="Car sharing info">
				<div class="title">
					<div class="title-text">Cambio car sharing</div>
				...
				<div class="footer">
					<span id="carCountdown" class="timer"></span>
				</div>
			</div>
			...
			<div class="item" id="air"  title="Air quality">
				<div class="title">
					<div class="title-text">Air quality</div>
					<div class="entypo-air"></div>
				</div>
				<div class="content">
					<img src="../img/loader.gif" class="loader"></img>
				</div>
